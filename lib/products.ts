...
export const products: Product[] = [
  ...
  },
  {
    ...
    description: "Everything you need for authentic Kanda Poha in one pack. Just add hot water, rest, and enjoy a soft, fragrant breakfast with onions, chilies and turmeric.",
    weight: "150 g",
    price: 70,
  ...
  },
  {
    ...
    description: "A savoury semolina premix with curry leaves, mustard and chilies. Add hot water for a warm, comforting upma anytime of the day.",
    weight: "150 g",
    price: 70,
    ...
    prepSteps: [
      "Empty the premix into a bowl.",
      "Add hot water according to the preparation instructions on the pack.",
      "Cover the bowl and let it rest.",
      "It will be ready in 5 minutes. Fluff gently and serve.",
    ],
  },
