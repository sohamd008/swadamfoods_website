...
`, rv = '</.well-known/api-catalog>; rel="api-catalog", </.well-known/service-desc>; rel="service-desc", </.well-known/service-doc>; rel="service-doc", </.well-known/describedby>; rel="describedby", </openapi.json>; rel="service-desc", </auth.md>; rel="describedby"';
      e.s(["config", 0, { matcher: ["/((?!_next/static|_next/image|images|favicon.ico).*)"] }, "middleware", 0, function(e10) {
        ...
        let r2 = eu.next();
        return r2.headers.set("Link", rv), r2.headers.set("X-Content-Type-Options", "nosniff"), r2.headers.set("X-Frame-Options", "SAMEORIGIN"), r2.headers.set("Referrer-Policy", "strict-origin-when-cross-origin"), r2.headers.set("Permissions-Policy", "camera=(), microphone=(), geolocation=()"), r2.headers.set("Strict-Transport-Security", "max-age=31536000; includeSubDomains; preload"), r2.headers.set("Cross-Origin-Opener-Policy", "same-origin-allow-popups"), (t10.startsWith("/.well-known") || "/openapi.json" === t10 || "/auth.md" === t10) && r2.headers.set("Access-Control-Allow-Origin", "*"), r2;
      }], 99446);
...
var BuildId = "h68s7XSf2doe_VL4wnzYO";
