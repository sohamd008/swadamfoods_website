...
`, ry = '</.well-known/api-catalog>; rel="api-catalog", </.well-known/service-desc>; rel="service-desc", </.well-known/service-doc>; rel="service-doc", </.well-known/describedby>; rel="describedby", </openapi.json>; rel="service-desc", </auth.md>; rel="describedby"', rw = /* @__PURE__ */ new Set(["/.well-known/api-catalog", "/.well-known/service-desc", "/.well-known/describedby", "/.well-known/acp.json", "/.well-known/ai-catalog.json", "/.well-known/mcp", "/.well-known/agent-skills", "/.well-known/ucp", "/.well-known/x402", "/.well-known/oauth-authorization-server", "/.well-known/oauth-protected-resource", "/.well-known/openid-configuration", "/openapi.json", "/auth.md"]);
      ...
      async function rR(e10, t10) {
        let r2 = await rC({ request: { url: e10.url, method: e10.method, headers: x(e10.headers), nextConfig: { basePath: "", i18n: "", trailingSlash: false, experimental: { cacheLife: { default: { stale: 300, revalidate: 900, expire: 4294967294 }, seconds: { stale: 30, revalidate: 1, expire: 60 }, minutes: { stale: 300, revalidate: 60, expire: 3600 }, hours: { stale: 300, revalidate: 3600, expire: 86400 }, days: { stale: 300, revalidate: 86400, expire: 604800 }, weeks: { stale: 300, revalidate: 604800, expire: 2592e3 }, max: { stale: 300, revalidate: 2592e3, expire: 31536e3 } }, authInterrupts: false, clientParamParsingOrigins: [] } }, page: { name: rx }, body: "GET" !== e10.method && "HEAD" !== e10.method ? e10.body ?? void 0 : void 0, waitUntil: t10.waitUntil, requestMeta: t10.requestMeta, signal: t10.signal || new AbortController().signal } });
        return null == t10.waitUntil || t10.waitUntil.call(t10, r2.waitUntil), r2.response;
      }
      e.s(["default", 0, rC, "handler", 0, rR], 42738);
    }]);
  }
});
...
var BuildId = "zdTJ0lq3m7TEZ2ni5Fpp6";
